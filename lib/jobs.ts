export const jobs = {
  ...
  sound: [
    ...
    { name: 'Musician', value: ['Music', 'Musician', 'Music Editor', 'Music Supervisor', 'Music Producer', 'Music Arranger'] },
    { name: 'Sound Designer', value: ['Sound Designer'] },
    { name: 'Sound Mixer', value: ['Sound Re-Recording Mixer', 'Sound Mixer'] },
    { name: 'Sound Editor', value: ['Sound Editor', 'Supervising Sound Editor', 'Sound Effects Editor'] },
